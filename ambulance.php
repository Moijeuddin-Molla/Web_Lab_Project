...
<section class="blogs" id="blogs">
    ...
    <h1 class="heading"> 24/7 <span>ambulance</span> </h1>

    <div class="box-container">

        <div class="box">
            <div class="image">
                <img src="image/ambulance-1.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
                    <a href="#"> <i class="fas fa-user"></i> from bangladesh </a>
                </div>
                <h3>RONy</h3>
                <p>there are 2 year experiance.</p>
        ...
        <div class="box">
            <div class="image">
                <img src="image/ambulance-2.png" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
                ...
                <h3>Dilip</h3>
                <p>there are 5 year experiance.</p>
                <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            <div class="image">
                <img src="image/ambulance-3.png" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/ambulance-4.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/ambulance-5.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/ambulance-6.png" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 01909491672 </a>
                ...
                <h3>Shahed</h3>
                <p>there are 6 year experiance.</p>
                <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
