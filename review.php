...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p class="text">this is very good website 24 hours provide a doctor,ambulance ,free checkups and behavior also good they are so many help in my regular life.Now i stay happy and comfort.Thak you so much to support my life</p>
        </div>

        <div class="box">
            <img src="image/perfect.jpg" alt="">
            <h3>CARENOW</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
