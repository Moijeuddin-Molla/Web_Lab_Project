...
<section class="blogs" id="blogs">
    ...
    <h1 class="heading"> DENTAL <span>CARE</span> </h1>

    <div class="box-container">

        <div class="box">
            <div class="image">
                <img src="image/dental-1.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
        ...
        <div class="box">
            <div class="image">
                <img src="image/dental-2.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/dental-3.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024</a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/dental-4.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/dental-5.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/dental-6.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024 </a>
