...
<head>
    ...
    <title>complete responsive hospital website create by SHUVO HALDER</title>
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    ...
                    <a href="#"> <i class="fas fa-user"></i> by CARENOW </a>
                </div>
                <h3>blog title CARENOW goes here</h3>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> shu123@gmai.com </a>
