...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>free checkups</h3>
            <p>all charge provide and control careNow medical center all charge are free you can just fill the from</p>
            <a href="free.php" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad, omnis.</p>
            <a href="doctors.php" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <div class="box">
            ...
            <h3>medicines</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad, omnis.</p>
            <a href="medicines.php" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
