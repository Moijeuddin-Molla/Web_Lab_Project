...
<section class="blogs" id="blogs">
    ...
    <h1 class="heading"> FREE <span>Checkups</span> </h1>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="https://www.justdial.com/Patna/Dr-Ms-Priya-Psychology-World-Opposite-PC-Jewellers-Boring-Road/0612PX612-X612-191205000943-E6U2_BZDET" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024 </a>
                    <a href="#"> <i class="fas fa-user"></i> from Nigeria </a>
                </div>
                <h3>MR.ROY</h3>
                <p>there are 5 year experiance.complete a MBBS from Nigeria</p>
                <a href="https://www.healthgrades.com/physician/dr-selika-sweet-x3vfp" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> 21 november, 2024</a>
                    <a href="#"> <i class="fas fa-user"></i> from bangladesh </a>
                </div>
                <h3>MS.Salika</h3>
                <p>there are 2 year experiance.complete a MBBS from Bangladesh</p>
