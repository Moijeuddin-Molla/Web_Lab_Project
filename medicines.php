...
<section class="blogs" id="blogs">
    ...
    <h1 class="heading"> Available <span>medicine</span> </h1>

    <div class="box-container">

        <div class="box">
            <div class="image">
                <img src="image/medicine-1.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:8.00 </a>
                    <a href="#"> <i class="fas fa-user"></i> from USA </a>
                </div>
                <h3>Maxpro </h3>
                <p>The medicine might be commonly prescribed by healthcare professionals due to its effectiveness or suitability for a wide range of patients.</p>
                <a href="orderNow.php" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>

        <div class="box">
            <div class="image">
                <img src="image/medicine-2.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15</a>
                    <a href="#"> <i class="fas fa-user"></i> from USA </a>
                </div>
                <h3>ALGIN</h3>
                <p>Algin is an antispasmodic drug that reduces muscles spasm of the intestine, biliary system, bladder and uterus</p>
                <a href="orderNow.php" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-3.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> Price:12</a>
                    <a href="#"> <i class="fas fa-user"></i> from USA </a>
                </div>
                <h3>Onvicon Plus </h3>
                <p>Gastric reflux,Heartburn,Indigestion,Flatulence associated with gastric reflux,Heartburn of pregnancy,All cases of epigastric and retrosternal distress where the underlying cause is gastric reflux.</p>
                <a href="orderNow.php" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        <div class="box">
            <div class="image">
                <img src="image/medicine-4.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> Price:24 </a>
                    <a href="#"> <i class="fas fa-user"></i> from USA </a>
                </div>
                <h3>Bisoren</h3>
                <p>Hypertension,Angina,Moderate to severe heart failure</p>
                <a href="orderNow.php" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        <div class="box">
            <div class="image">
                <img src="image/medicine-5.png" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
                    <a href="#"> <i class="fas fa-user"></i> From france </a>
                </div>
                <h3>Rolip</h3>
                <p>there are 2 year experiance.complete a MBBS from france</p>
                <a href="orderNow.html" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        <div class="box">
            <div class="image">
                <img src="image/medicine-6.jpg" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
                    <a href="#"> <i class="fas fa-user"></i>from australia </a>
                </div>
                <h3>Gavisol</h3>
                <p>there are 6 year experiance.complete a MBBS from australia</p>
                <a href="orderNow.html" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-7.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
                ...
                <h3>Othera</h3>
                <p>there are 2 year experiance.complete a MBBS from australia</p>
                <a href="orderNow.html" class="btn"> Order NOW <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-8.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-9.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-10.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-11.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="image/medicine-12.webp" alt="">
            </div>
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:15 </a>
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    <a href="#"> <i class="fas fa-calendar"></i> price:34 </a>
                    <a href="#"> <i class="fas fa-user"></i> from australia </a>
                </div>
                <h3>Onvicon</h3>
                <p>there are 2 year experiance.complete a MBBS from australia</p>
